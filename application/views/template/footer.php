                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 hidden-xs hidden-sm " align="center">
                                            <ul class="footer-menu">
                                                ...
                                                <li>
                                                    <a href="#">Jobs in Eastern </a>
                                                </li>
                                                <li>
                                                    <a href="#">Jobs in Southern</a>
                                                </li>
                                                <li>
                                                    <a href="#">Jobs in Sabaragamuwa</a>
                                                </li>
                                                <li>
                                                    <a href="#">Jobs in Central</a>
                                                </li>
                                                <li>
                                                    <a href="#">Jobs in Uva</a>
                                                </li>
                                                <li>
                                                    <a href="#">Jobs in Northern</a>
                                                </li>    
                                                      
                                                <li>
                                                    <a href="#">Jobs in North Central </a>
                                                </li>
